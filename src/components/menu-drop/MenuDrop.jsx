...
var MenuDrop = /** @class */ (function (_super) {
    ...
    MenuDrop.prototype.render = function () {
        var _a = this.props, align = _a.align, anchorOffset = _a.anchorOffset, backgroundStyle = _a.backgroundStyle, children = _a.children, className = _a.className, containerStyle = _a.containerStyle, open = _a.open, size = _a.size, style = _a.style, rest = __rest(_a, ["align", "anchorOffset", "backgroundStyle", "children", "className", "containerStyle", "open", "size", "style"]);
        var width;
        switch (typeof size) {
            case 'number':
                width = size;
        ...
        return open === false || this.state.closed ? null : (<div {...rest} className={"menu-drop" + (className ? ' ' + className : '')} 
        //@ts-ignore
        style={Object.assign({
            width: anchorOffset || 0
        }, containerStyle)}>
        <div className={'background'} onClick={this.close} style={backgroundStyle}/>
        <__1.Content className={'menu'} 
        //@ts-ignore
        style={Object.assign({
            width: width,
            float: align || 'left'
