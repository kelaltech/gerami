...
var Input = /** @class */ (function (_super) {
    ...
    Input.prototype.render = function () {
        var _this = this;
        var _a = this.props, className = _a.className, label = _a.label, onBlur = _a.onBlur, onChange = _a.onChange, onFocus = _a.onFocus, onKeyDown = _a.onKeyDown, onKeyUp = _a.onKeyUp, placeholder = _a.placeholder, rest = __rest(_a, ["className", "label", "onBlur", "onChange", "onFocus", "onKeyDown", "onKeyUp", "placeholder"]);
        //@ts-ignore
        !rest || delete rest.inputRef;
        return (<label className={"label" + (className ? ' ' + className : '')}>
        <input type={'text'} className={'input'} {...rest} onBlur={function (e) {
            _this.updateFloat();
