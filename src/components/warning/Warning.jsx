...
var Warning = /** @class */ (function (_super) {
    ...
    Warning.prototype.render = function () {
        var _this = this;
        var _a = this.props, children = _a.children, className = _a.className, problem = _a.problem, shy = _a.shy, rest = __rest(_a, ["children", "className", "problem", "shy"]);
        //@ts-ignore
        !rest || delete rest.bomb;
        return this.dead || this.state.hidden ? null : (<__1.Content title={shy ? 'Double click to hide warning' : undefined} {...rest} className={"warning" + (className ? ' ' + className : '')} onDoubleClick={function (e) {
            _this.shyAway();
            if (typeof rest.onDoubleClick === 'function')
                rest.onClick(e);
        }}>
        <__2.Block>
          {children ||
            (problem ? (<div className={'font-S center'}>
